...
---
# 如何使用 PowerShell 指令碼建立復原映像


## <a href="" id="bkmk-create-image-use-script"></a>使用 PowerShell 腳本建立 DaRT 復原影像


您可以使用 PowerShell 腳本（而不是使用 DaRT 8.0 復原映像嚮導）來建立 Microsoft Diagnostics 和復原工具集（DaRT）8.0 復原影像。 請參閱下列範例腳本。
...
`Import-Module "Dism"`是否`mport-Module "Microsoft.Dart"`
