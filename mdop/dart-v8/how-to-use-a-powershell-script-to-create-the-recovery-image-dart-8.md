---
title: 如何使用 PowerShell 指令碼建立復原映像
description: 如何使用 PowerShell 指令碼建立復原映像
author: dansimp
...
ms.locfileid: "10809626"
---
# <span data-ttu-id="a3863-103">如何使用 PowerShell 指令碼建立復原映像</span><span class="sxs-lookup"><span data-stu-id="a3863-103">How to Use a PowerShell Script to Create the Recovery Image</span></span>


## <a href="" id="bkmk-create-image-use-script"></a><span data-ttu-id="a3863-104">使用 PowerShell 腳本建立 DaRT 復原影像</span><span class="sxs-lookup"><span data-stu-id="a3863-104">To create the DaRT recovery image by using a PowerShell script</span></span>


<span data-ttu-id="a3863-105">您可以使用 PowerShell 腳本（而不是使用 DaRT 8.0 復原映像嚮導）來建立 Microsoft Diagnostics 和復原工具集（DaRT）8.0 復原影像。</span><span class="sxs-lookup"><span data-stu-id="a3863-105">You can create the Microsoft Diagnostics and Recovery Toolset (DaRT) 8.0 recovery image by using a PowerShell script instead of using the DaRT 8.0 Recovery Image wizard.</span></span> <span data-ttu-id="a3863-106">請參閱下列範例腳本。</span><span class="sxs-lookup"><span data-stu-id="a3863-106">See the following example script.</span></span>
...
`Import-Module "Dism"`<span data-ttu-id="a3863-107">是否</span><span class="sxs-lookup"><span data-stu-id="a3863-107">I</span></span>`mport-Module "Microsoft.Dart"`
...
## <span data-ttu-id="a3863-108">相關主題</span><span class="sxs-lookup"><span data-stu-id="a3863-108">Related topics</span></span>


[<span data-ttu-id="a3863-109">使用 PowerShell 管理 DaRT 8.0</span><span class="sxs-lookup"><span data-stu-id="a3863-109">Administering DaRT 8.0 Using PowerShell</span></span>](administering-dart-80-using-powershell-dart-8.md)
