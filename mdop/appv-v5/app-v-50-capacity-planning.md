...
-   <span data-ttu-id="7c641-134">**完整的基礎結構模型**-完整的基礎結構模型可提供軟體發佈、管理和報告功能;它也包含跨網路的應用程式資料流程。</span><span class="sxs-lookup"><span data-stu-id="7c641-134">**Full Infrastructure Model** - The full infrastructure model provides for software distribution, management, and reporting capabilities; it also includes the streaming of applications across the network.</span></span> <span data-ttu-id="7c641-135">App-v 5.0 完整基礎結構模型是由一或多個 App-v 5.0 管理伺服器所組成。</span><span class="sxs-lookup"><span data-stu-id="7c641-135">The App-V 5.0 Full Infrastructure Model consists of one or more App-V 5.0 management servers.</span></span> <span data-ttu-id="7c641-136">管理伺服器可以用來將應用程式發佈到所有用戶端。</span><span class="sxs-lookup"><span data-stu-id="7c641-136">The Management Server can be used to publish applications to all clients.</span></span> <span data-ttu-id="7c641-137">發佈程式會將虛擬應用程式圖示和快速鍵放在目的電腦上。</span><span class="sxs-lookup"><span data-stu-id="7c641-137">The publishing process places the virtual application icons and shortcuts on the target computer.</span></span> <span data-ttu-id="7c641-138">它也可以將應用程式流式資料流程給本機使用者。</span><span class="sxs-lookup"><span data-stu-id="7c641-138">It can also stream applications to local users.</span></span> <span data-ttu-id="7c641-139">如需安裝管理伺服器的詳細資訊，請參閱[規劃 app-v 5.0 Server 部署](planning-for-the-app-v-50-server-deployment.md)。</span><span class="sxs-lookup"><span data-stu-id="7c641-139">For more information about installing the management server see, [Planning for the App-V 5.0 Server Deployment](planning-for-the-app-v-50-server-deployment.md).</span></span> <span data-ttu-id="7c641-140">針對下列案例，建議使用完整的基礎結構模型：</span><span class="sxs-lookup"><span data-stu-id="7c641-140">The full infrastructure model is recommended for the following scenarios:</span></span>
    ...
    <span data-ttu-id="7c641-141">**重要** App-v 5.0 完整基礎結構模型需要 Microsoft SQL Server 來儲存配置資料。</span><span class="sxs-lookup"><span data-stu-id="7c641-141">**Important** The App-V 5.0 full infrastructure model requires Microsoft SQL Server to store configuration data.</span></span> <span data-ttu-id="7c641-142">如需詳細資訊，請參閱[app-v 5.0 支援的](app-v-50-supported-configurations.md)設定。</span><span class="sxs-lookup"><span data-stu-id="7c641-142">For more information see [App-V 5.0 Supported Configurations](app-v-50-supported-configurations.md).</span></span>
...
<li><p><span data-ttu-id="7c641-171">針對 &lt; 50 同時要求中繼資料的發佈伺服器，往返行程回應時間為 &lt; 5 秒。</span><span class="sxs-lookup"><span data-stu-id="7c641-171">For &lt;50 publishing servers requesting metadata simultaneously, the round trip response time is &lt;5 seconds.</span></span></p></li>
...
<th align="left"><span data-ttu-id="7c641-183">存取群組的數目</span><span class="sxs-lookup"><span data-stu-id="7c641-183">Number of access groups</span></span></th>
...
<li><p><span data-ttu-id="7c641-207">320</span><span class="sxs-lookup"><span data-stu-id="7c641-207">320</span></span></p></li>
</ul></td>
<td align="left"><p></p>
<ul>
...
<li><p><span data-ttu-id="7c641-232">300</span><span class="sxs-lookup"><span data-stu-id="7c641-232">300</span></span></p></li>
...
<li><p><span data-ttu-id="7c641-281">LAN</span><span class="sxs-lookup"><span data-stu-id="7c641-281">LAN</span></span></p></li>
</ul></td>
<td align="left"><p></p>
<ul>
...
<th align="left"><span data-ttu-id="7c641-296">連線群組數目</span><span class="sxs-lookup"><span data-stu-id="7c641-296">Number of connection groups</span></span></th>
...
## <a href="" id="---------app-v-5-0-publishing-server-capacity-planning-recommendations"></a> <span data-ttu-id="7c641-356">App-V 5.0 發佈伺服器容量規劃建議</span><span class="sxs-lookup"><span data-stu-id="7c641-356">App-V 5.0 Publishing Server Capacity Planning Recommendations</span></span>
...
<li><p><span data-ttu-id="7c641-371">含四核的發佈伺服器在3秒內可以重新整理至10000套件。</span><span class="sxs-lookup"><span data-stu-id="7c641-371">A publishing server with a quad core can refresh up to 10000 packages within 3 seconds.</span></span> <span data-ttu-id="7c641-372">（支援10000併發用戶端）</span><span class="sxs-lookup"><span data-stu-id="7c641-372">(Supporting 10000 simultaneous clients)</span></span></p></li>
</ul></td>
</tr>
<tr class="even">
...
<th align="left"><span data-ttu-id="7c641-384">網路連線類型發佈 server/App-v 5.0 用戶端</span><span class="sxs-lookup"><span data-stu-id="7c641-384">Network connection type publishing server / App-V 5.0 client</span></span></th>
...
<td align="left"><p></p>
<ul>
<li><p><span data-ttu-id="7c641-405">sr-1</span><span class="sxs-lookup"><span data-stu-id="7c641-405">1</span></span></p></li>
...
<td align="left"><p></p>
<ul>
<li><p><span data-ttu-id="7c641-425">92</span><span class="sxs-lookup"><span data-stu-id="7c641-425">92</span></span></p></li>
...
<td align="left"><p></p>
<ul>
<li><p><span data-ttu-id="7c641-467">100</span><span class="sxs-lookup"><span data-stu-id="7c641-467">100</span></span></p></li>
...
<tr class="even">
<td align="left"><p><span data-ttu-id="7c641-491">正在進行資料流程處理的每個套件大小。</span><span class="sxs-lookup"><span data-stu-id="7c641-491">Size of each package being streamed.</span></span></p></td>
<td align="left"><p><span data-ttu-id="7c641-492">每個套件的大小。</span><span class="sxs-lookup"><span data-stu-id="7c641-492">Size of each package.</span></span></p></td>
<td align="left"><p></p>
<ul>
<li><p><span data-ttu-id="7c641-493">100</span><span class="sxs-lookup"><span data-stu-id="7c641-493">100</span></span></p></li>
<li><p><span data-ttu-id="7c641-494">200</span><span class="sxs-lookup"><span data-stu-id="7c641-494">200</span></span></p></li>
<li><p></p></li>
<li><p><span data-ttu-id="7c641-495">100</span><span class="sxs-lookup"><span data-stu-id="7c641-495">100</span></span></p></li>
<li><p><span data-ttu-id="7c641-496">200</span><span class="sxs-lookup"><span data-stu-id="7c641-496">200</span></span></p></li>
</ul></td>
<td align="left"><p></p>
<ul>
<li><p><span data-ttu-id="7c641-497">21 MB</span><span class="sxs-lookup"><span data-stu-id="7c641-497">21 MB</span></span></p></li>
<li><p><span data-ttu-id="7c641-498">21 MB</span><span class="sxs-lookup"><span data-stu-id="7c641-498">21 MB</span></span></p></li>
<li><p></p></li>
<li><p><span data-ttu-id="7c641-499">109</span><span class="sxs-lookup"><span data-stu-id="7c641-499">109</span></span></p></li>
<li><p><span data-ttu-id="7c641-500">109</span><span class="sxs-lookup"><span data-stu-id="7c641-500">109</span></span></p></li>
</ul></td>
<td align="left"><p></p>
<ul>
<li><p><span data-ttu-id="7c641-501">LAN</span><span class="sxs-lookup"><span data-stu-id="7c641-501">LAN</span></span></p></li>
<li><p><span data-ttu-id="7c641-502">LAN</span><span class="sxs-lookup"><span data-stu-id="7c641-502">LAN</span></span></p></li>
<li><p></p></li>
<li><p><span data-ttu-id="7c641-503">LAN</span><span class="sxs-lookup"><span data-stu-id="7c641-503">LAN</span></span></p></li>
<li><p><span data-ttu-id="7c641-504">LAN</span><span class="sxs-lookup"><span data-stu-id="7c641-504">LAN</span></span></p></li>
</ul></td>
<td align="left"><p></p>
<p><span data-ttu-id="7c641-505">33</span><span class="sxs-lookup"><span data-stu-id="7c641-505">33</span></span></p>
<p><span data-ttu-id="7c641-506">83</span><span class="sxs-lookup"><span data-stu-id="7c641-506">83</span></span></p>
<p></p>
<p><span data-ttu-id="7c641-507">100</span><span class="sxs-lookup"><span data-stu-id="7c641-507">100</span></span></p>
<p><span data-ttu-id="7c641-508">160</span><span class="sxs-lookup"><span data-stu-id="7c641-508">160</span></span></p></td>
</tr>
<tr class="odd">
<td align="left"><p><span data-ttu-id="7c641-509">用戶端與 App-v 5.0 流式處理伺服器之間的網路連線。</span><span class="sxs-lookup"><span data-stu-id="7c641-509">Network connection between client and App-V 5.0 streaming server.</span></span></p></td>
<td align="left"><p><span data-ttu-id="7c641-510">1.5 Mbps 低速連結網路。</span><span class="sxs-lookup"><span data-stu-id="7c641-510">1.5 Mbps Slow link network.</span></span></p></td>
<td align="left"><p></p>
<ul>
<li><p><span data-ttu-id="7c641-511">100</span><span class="sxs-lookup"><span data-stu-id="7c641-511">100</span></span></p></li>
<li><p></p></li>
<li><p><span data-ttu-id="7c641-512">100</span><span class="sxs-lookup"><span data-stu-id="7c641-512">100</span></span></p></li>
</ul></td>
<td align="left"><p></p>
<ul>
<li><p><span data-ttu-id="7c641-513">3.5 MB</span><span class="sxs-lookup"><span data-stu-id="7c641-513">3.5 MB</span></span></p></li>
<li><p></p></li>
<li><p><span data-ttu-id="7c641-514">5 MB</span><span class="sxs-lookup"><span data-stu-id="7c641-514">5 MB</span></span></p></li>
</ul></td>
<td align="left"><p></p>
<ul>
<li><p><span data-ttu-id="7c641-515">1.5 Mbps 的大陸內部網路</span><span class="sxs-lookup"><span data-stu-id="7c641-515">1.5 Mbps Intra-Continental Network</span></span></p></li>
</ul></td>
<td align="left"><p></p>
<p><span data-ttu-id="7c641-516">102</span><span class="sxs-lookup"><span data-stu-id="7c641-516">102</span></span></p>
<p></p>
<p><span data-ttu-id="7c641-517">121</span><span class="sxs-lookup"><span data-stu-id="7c641-517">121</span></span></p></td>
</tr>
</tbody>
</table>
...
<span data-ttu-id="7c641-518">每個應用程式 V 5.0 流式處理伺服器都應該能夠處理同時流式處理的虛擬化應用程式最少的200個用戶端。</span><span class="sxs-lookup"><span data-stu-id="7c641-518">Each App-V 5.0 streaming server should be able to handle a minimum of 200 clients concurrently streaming virtualized applications.</span></span>

<span data-ttu-id="7c641-519">**記事** 資料流程的實際時間是由同時流式處理的用戶端數、套件數目、套件大小、伺服器的網路活動和網路狀況決定。</span><span class="sxs-lookup"><span data-stu-id="7c641-519">**Note** The actual time to it will take to stream is determined primarily by the number of clients streaming simultaneously, number of packages, package size, the server’s network activity, and network conditions.</span></span>

 

<span data-ttu-id="7c641-520">例如，當100同步處理的用戶端從伺服器傳送時，一般的使用者可以將 100 MB 套件資料流程傳輸在2分鐘以內。</span><span class="sxs-lookup"><span data-stu-id="7c641-520">For example, an average user can stream a 100 MB package in less than 2 minutes, when 100 simultaneous clients are streaming from the server.</span></span> <span data-ttu-id="7c641-521">不過，大小為 1 GB 的套件可能需要長達30分鐘的時間。</span><span class="sxs-lookup"><span data-stu-id="7c641-521">However, a package of size 1 GB could take up to 30 minutes.</span></span> <span data-ttu-id="7c641-522">在大部分實際環境中，資料流程需求不會均勻分佈，您必須瞭解環境中所提供的大約峰值流量需求，才能正確地調整所需的流式處理伺服器數目。</span><span class="sxs-lookup"><span data-stu-id="7c641-522">In most real world environments streaming demand is not uniformly distributed, you will need to understand the approximate peak streaming requirements present in your environment in order to properly size the number of required streaming servers.</span></span>

<span data-ttu-id="7c641-523">如果您已預先快取您的應用程式，可能會大幅增加流式處理伺服器支援的用戶端數目，並減少峰值流量需求。</span><span class="sxs-lookup"><span data-stu-id="7c641-523">The number of clients a streaming server can support can be significantly increased and the peak streaming requirements reduced if you pre-cache your applications.</span></span> <span data-ttu-id="7c641-524">您也可以使用點播流式傳遞和資料流程優化套件，增加流式處理伺服器可支援的用戶端數量。</span><span class="sxs-lookup"><span data-stu-id="7c641-524">You can also increase the number of clients a streaming server can support by using on-demand streaming delivery and stream optimized packages.</span></span>

## <span data-ttu-id="7c641-525">結合 app-v 5.0 伺服器角色</span><span class="sxs-lookup"><span data-stu-id="7c641-525">Combining App-V 5.0 Server Roles</span></span>


<span data-ttu-id="7c641-526">折扣調整比例與容錯需求，與 Active Directory 連通的位置所需的伺服器數量最少為1。</span><span class="sxs-lookup"><span data-stu-id="7c641-526">Discounting scaling and fault-tolerance requirements, the minimum number of servers needed for a location with connectivity to Active Directory is one.</span></span> <span data-ttu-id="7c641-527">此伺服器將託管管理伺服器、管理伺服器服務及 Microsoft SQL Server 角色。</span><span class="sxs-lookup"><span data-stu-id="7c641-527">This server will host the management server, management server service, and Microsoft SQL Server roles.</span></span> <span data-ttu-id="7c641-528">因此，伺服器角色可以依任何所需的組合來排列，因為它們不會相互衝突。</span><span class="sxs-lookup"><span data-stu-id="7c641-528">Server roles, therefore, can be arranged in any desired combination since they do not conflict with one another.</span></span>

<span data-ttu-id="7c641-529">忽略縮放需求，提供容錯實現所需的伺服器數量最少為4個。</span><span class="sxs-lookup"><span data-stu-id="7c641-529">Ignoring scaling requirements, the minimum number of servers necessary to provide a fault-tolerant implementation is four.</span></span> <span data-ttu-id="7c641-530">管理伺服器以及 Microsoft SQL Server 角色支援將其放在容錯設定中。</span><span class="sxs-lookup"><span data-stu-id="7c641-530">The management server, and Microsoft SQL Server roles support being placed in fault-tolerant configurations.</span></span> <span data-ttu-id="7c641-531">管理伺服器服務可以與任何角色結合，但仍會保持單一失敗點。</span><span class="sxs-lookup"><span data-stu-id="7c641-531">The management server service can be combined with any of the roles, but remains a single point of failure.</span></span>

<span data-ttu-id="7c641-532">雖然有許多容錯策略和技術可供使用，但並非所有都適用于特定的服務。</span><span class="sxs-lookup"><span data-stu-id="7c641-532">Although there are a number of fault-tolerance strategies and technologies available, not all are applicable to a given service.</span></span> <span data-ttu-id="7c641-533">此外，如果結合 app-v 5.0 角色，則某些容錯選項可能會因為不相容而不再適用。</span><span class="sxs-lookup"><span data-stu-id="7c641-533">Additionally, if App-V 5.0 roles are combined, certain fault-tolerance options may no longer apply due to incompatibilities.</span></span>
...
## <span data-ttu-id="7c641-534">相關主題</span><span class="sxs-lookup"><span data-stu-id="7c641-534">Related topics</span></span>


[<span data-ttu-id="7c641-535">App-V 5.0 支援的組態</span><span class="sxs-lookup"><span data-stu-id="7c641-535">App-V 5.0 Supported Configurations</span></span>](app-v-50-supported-configurations.md)

[<span data-ttu-id="7c641-536">App-V 5.0 高可用性規劃</span><span class="sxs-lookup"><span data-stu-id="7c641-536">Planning for High Availability with App-V 5.0</span></span>](planning-for-high-availability-with-app-v-50.md)

[<span data-ttu-id="7c641-537">規劃部署 App-V</span><span class="sxs-lookup"><span data-stu-id="7c641-537">Planning to Deploy App-V</span></span>](planning-to-deploy-app-v.md)
