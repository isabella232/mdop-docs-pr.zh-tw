...
-   [用於查看發佈中繼資料的 app-v 5.0 SP3 需求](#bkmk-50sp3-reqs-pub-meta)
...
## <a href="" id="bkmk-50sp3-reqs-pub-meta"></a>用於查看發佈中繼資料的 app-v 5.0 SP3 需求
...
<div class="alert">
<strong>注意</strong><br/><p><strong></strong> <strong> </strong> 只有在 app-v 5.0 SP3 中才支援 ClientVersion 和 ClientOS。</p>
</div>
<div>

</div></td>
<td align="left"><p>請參閱 App-v 5.0 SP3 的相關資訊。</p></td>
