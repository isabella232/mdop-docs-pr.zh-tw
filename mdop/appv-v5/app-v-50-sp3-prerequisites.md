...
在安裝 Microsoft Application Virtualization （App-v） 5.0 SP3 前，請確定您已安裝下列所有必要的軟體。

如需支援的作業系統及 app-v Server、Sequencer 及用戶端的硬體需求清單，請參閱[app-v 5.0 SP3 支援](app-v-50-sp3-supported-configurations.md)的設定。
...
針對 App-V 5.0 SP3 伺服器元件安裝必要的必備軟體。
...
<td align="left"><ul>
<li><p>在執行 App-V 任何舊版或元件的電腦上安裝 App-v 伺服器。</p></li>
...
<td align="left"><p>如需支援的版本，請參閱 <a href="app-v-50-sp3-supported-configurations.md" data-raw-source="[App-V 5.0 SP3 Supported Configurations](app-v-50-sp3-supported-configurations.md)"> App-V 5.0 SP3 支援 </a> 的配置。</p></td>
</tr>
<tr class="even">
...
<td align="left"><p>只有安裝 Silverlight，才能使用管理主控台。</p></td>
</tr>
</tbody>
</table>
...
只有在您使用 App-v 5.0 SP3 管理伺服器時，才需要管理資料庫。
...
只有在您使用 App-v 5.0 SP3 報表服務器時，才需要報告資料庫。
...
-   排序程式需要大量的資源，因此請確定執行排序器的電腦有大量的記憶體、快速的處理器，以及快速硬碟。 本機安裝的應用程式的系統需求不能超過排序器的要求。 如需詳細資訊，請參閱[App-V 5.0 支援的](app-v-50-supported-configurations.md)設定。
