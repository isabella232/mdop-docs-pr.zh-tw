...
若要讓用戶端電腦透過 MBAM Configuration Manager 報告來報告 BitLocker 合規性詳細資料，您必須編輯**Configuration. mof**檔案（無論您使用的是 SystemCenter2012 ConfigurationManager 或 Configuration Manager 2007）。 針對您正在使用的 Configuration Manager 版本完成下列指示。
