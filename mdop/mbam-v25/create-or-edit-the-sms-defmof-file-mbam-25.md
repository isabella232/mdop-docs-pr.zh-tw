...
如果您使用的是 SystemCenter2012 ConfigurationManager，則必須建立檔案。 在頂層網站上建立檔案。 變更將會複製到您基礎結構中的其他網站。

在 Configuration Manager 2007 中，該檔案已存在，因此您只需要進行編輯。 **不要覆寫現有的檔案。**
...
3.  修改**Win32 \ _Tpm**類別，如下所示：
    ...
    **取得 MBAM 的建議**嗎？ 在[此](http://mbam.uservoice.com/forums/268571-microsoft-bitlocker-administration-and-monitoring)新增或投票建議。 **遇到 MBAM 問題**嗎？ 使用[MBAM TechNet 論壇](https://social.technet.microsoft.com/Forums/home?forum=mdopmbam)。
