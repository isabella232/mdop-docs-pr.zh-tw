...
ms.locfileid: "10809579"
---
# <span data-ttu-id="8250d-103">如何使用 PowerShell 指令碼建立復原映像</span><span class="sxs-lookup"><span data-stu-id="8250d-103">How to Use a PowerShell Script to Create the Recovery Image</span></span>


## <a href="" id="bkmk-create-image-use-script"></a><span data-ttu-id="8250d-104">使用 PowerShell 腳本建立 DaRT 復原影像</span><span class="sxs-lookup"><span data-stu-id="8250d-104">To create the DaRT recovery image by using a PowerShell script</span></span>


<span data-ttu-id="8250d-105">您可以使用 PowerShell 腳本（而不是使用 DaRT 10 復原影像嚮導）來建立 Microsoft Diagnostics 與復原工具庫（DaRT）10復原影像。</span><span class="sxs-lookup"><span data-stu-id="8250d-105">You can create the Microsoft Diagnostics and Recovery Toolset (DaRT) 10 recovery image by using a PowerShell script instead of using the DaRT 10 Recovery Image wizard.</span></span> <span data-ttu-id="8250d-106">請參閱下列範例腳本。</span><span class="sxs-lookup"><span data-stu-id="8250d-106">See the following example script.</span></span>
...
`Import-Module "Dism"`<span data-ttu-id="8250d-107">是否</span><span class="sxs-lookup"><span data-stu-id="8250d-107">I</span></span>`mport-Module "Microsoft.Dart"`
...
## <span data-ttu-id="8250d-108">相關主題</span><span class="sxs-lookup"><span data-stu-id="8250d-108">Related topics</span></span>


[<span data-ttu-id="8250d-109">使用 PowerShell 管理 DaRT 10</span><span class="sxs-lookup"><span data-stu-id="8250d-109">Administering DaRT 10 Using PowerShell</span></span>](administering-dart-10-using-powershell.md)
